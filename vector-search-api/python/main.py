...
query = os.getenv("QUERY", "react framework")
...
print("BuiltWith Vector Search API")
print(f"Searching for: {query}")
print("---")

response = requests.get("https://api.builtwith.com/vector/v1/api.json", params={"KEY": api_key, "QUERY": query})
