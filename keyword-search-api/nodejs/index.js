...
const params = new URLSearchParams({ KEY: apiKey, KEYWORD: keyword });
const url = `https://api.builtwith.com/kws1/api.json?${params.toString()}`;

console.log('BuiltWith Keyword Search API');
